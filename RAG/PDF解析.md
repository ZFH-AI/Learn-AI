...
# 2、解析PDF的挑战
PDF文档是非结构化文档的代表，但是从PDF文档中提取信息是一个具有挑战性的过程。与其说PDF是一种数据格式，不如将其描述为打印指令的集合更为准确。PDF文件由一系列指令组成，这些指令指示PDF阅读器或打印机在屏幕或纸张上显示符号的位置和方式。这与HTML和docx等文件格式形成对比，后者使用 <p>、<w:p>、<table>和 <w:tbl>来组织不同的逻辑结构
